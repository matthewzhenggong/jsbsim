...
void FGAuxiliary::bind(void)
{
  ...
  PropertyManager->Tie("propulsion/pt-pa", this, &FGAuxiliary::GetTotalPressureSI);
  ...
  PropertyManager->Tie("velocities/vc-mps", this, &FGAuxiliary::GetVcalibratedMPS);
  PropertyManager->Tie("velocities/vc-kmps", this, &FGAuxiliary::GetVcalibratedKMPH);
  ...
  PropertyManager->Tie("velocities/ve-mps", this, &FGAuxiliary::GetVequivalentMPS);
  PropertyManager->Tie("velocities/ve-kmph", this, &FGAuxiliary::GetVequivalentKMPH);
  ...
  PropertyManager->Tie("velocities/vtrue-mps", this, &FGAuxiliary::GetVtrueMPS);
  PropertyManager->Tie("velocities/vtrue-kmph", this, &FGAuxiliary::GetVtrueKMPH);
  ...
  PropertyManager->Tie("velocities/p-aero-deg_sec", this, eX, (PMF)&FGAuxiliary::GetAeroPQRDeg);
  PropertyManager->Tie("velocities/q-aero-deg_sec", this, eY, (PMF)&FGAuxiliary::GetAeroPQRDeg);
  PropertyManager->Tie("velocities/r-aero-deg_sec", this, eZ, (PMF)&FGAuxiliary::GetAeroPQRDeg);
  ...
  PropertyManager->Tie("velocities/phidot-deg_sec", this, ePhi, (PMF)&FGAuxiliary::GetEulerRatesDeg);
  PropertyManager->Tie("velocities/thetadot-deg_sec", this, eTht, (PMF)&FGAuxiliary::GetEulerRatesDeg);
  PropertyManager->Tie("velocities/psidot-deg_sec", this, ePsi, (PMF)&FGAuxiliary::GetEulerRatesDeg);
  PropertyManager->Tie("velocities/u-aero-fps", this, eU, (PMF)&FGAuxiliary::GetAeroUVW);
  PropertyManager->Tie("velocities/u-aero-mps", this, eU, (PMF)&FGAuxiliary::GetAeroUVWSI);
  PropertyManager->Tie("velocities/v-aero-fps", this, eV, (PMF)&FGAuxiliary::GetAeroUVW);
  PropertyManager->Tie("velocities/v-aero-mps", this, eV, (PMF)&FGAuxiliary::GetAeroUVWSI);
  PropertyManager->Tie("velocities/w-aero-fps", this, eW, (PMF)&FGAuxiliary::GetAeroUVW);
  PropertyManager->Tie("velocities/w-aero-mps", this, eW, (PMF)&FGAuxiliary::GetAeroUVWSI);
  PropertyManager->Tie("velocities/vt-fps", this, &FGAuxiliary::GetVt);
  PropertyManager->Tie("velocities/vt-mps", this, &FGAuxiliary::GetVtSI);
  ...
  PropertyManager->Tie("velocities/vg-mps", this, &FGAuxiliary::GetVgroundSI);
  ...
  PropertyManager->Tie("accelerations/a-pilot-x-mt_sec2", this, eX, (PMF)&FGAuxiliary::GetPilotAccelSI);
  PropertyManager->Tie("accelerations/a-pilot-y-mt_sec2", this, eY, (PMF)&FGAuxiliary::GetPilotAccelSI);
  PropertyManager->Tie("accelerations/a-pilot-z-mt_sec2", this, eZ, (PMF)&FGAuxiliary::GetPilotAccelSI);
  ...
  PropertyManager->Tie("aero/qbar-pa", this, &FGAuxiliary::GetqbarSI);
  PropertyManager->Tie("aero/qbarUW-psf", this, &FGAuxiliary::GetqbarUW);
  PropertyManager->Tie("aero/qbarUW-pa", this, &FGAuxiliary::GetqbarUWSI);
  PropertyManager->Tie("aero/qbarUV-psf", this, &FGAuxiliary::GetqbarUV);
  PropertyManager->Tie("aero/qbarUV-pa", this, &FGAuxiliary::GetqbarUVSI);
  ...
  PropertyManager->Tie("aero/h_b-cg-mt", this, &FGAuxiliary::GetHOverBCGSI);
  PropertyManager->Tie("aero/h_b-mac-ft", this, &FGAuxiliary::GetHOverBMAC);
  PropertyManager->Tie("aero/h_b-mac-mt", this, &FGAuxiliary::GetHOverBMACSI);
  ...
  PropertyManager->Tie("flight-path/gamma-deg", this, &FGAuxiliary::GetGammaDeg);
  PropertyManager->Tie("flight-path/psi-gt-deg", this, &FGAuxiliary::GetGroundTrackDeg);
  ...
  PropertyManager->Tie("position/vrp-radius-mt", &vLocationVRP, &FGLocation::GetRadiusSI);
}
